...
int main() {
	...
	double horas_inicial, minutos_inicial, segundos_inicial, 
	...
	// CUERPO DEL PROGRAMA 
	segundos_total_final = horas_final * 3600 + minutos_final * 60 + segundos_final;
	segundos_total_inicial = horas_inicial * 3600 + minutos_inicial * 60 + segundos_inicial;
