...
int main() {
	...
	double ingresos, disenador, empleados;

	// ENTRADA DE DATOS DEL PROGRAMA
	cout << "Introducca los beneficios de la empresa: ";
	cin >> ingresos;

	// CUERPO DEL PROGRAMA 
	empleados = (ingresos / 5);
	disenador = empleados * 2;

	// SALIDA DE DATOS
	cout << "El salario del empleado es de: " << empleados << endl
		<< "El salario del diseñador es de: " << disenador << endl;
