...
const int VENTA_MINIMO = 700;
const int UNIDADES_MINIMAS = 100;
...
int main() {
	...
	double dinero_venta, venta_final, unidades;

	// ENTRADA DE DATOS DEL PROGRAMA
	cout << "Introduce el precio total de la venta: ";
	cin >> dinero_venta;
	cout << "Introduce unidades de venta: ";
	cin >> unidades;

	// CUERPO DEL PROGRAMA 
	if (dinero_venta>VENTA_MINIMO && unidades>UNIDADES_MINIMAS)
		venta_final = dinero_venta - dinero_venta * 0.02;
	else
		venta_final = dinero_venta;

	// SALIDA DE DATOS
	cout << "El dinero final a pagar es de: " << venta_final << endl;
