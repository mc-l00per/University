...
/**
 * Funcion para leer y comprobar un entero
 * @see LeerEnteroPositivo
 */
void LeerEnteroPositivo(){
	do {
...
/**
 * Funcion para calcular el factor de n
 * @see Factorial
 * @param n Valor del entero
 * @return factorial Valor factorial del entero
 */
...
int main() {
	...
	// SALIDA DE DATOS
	cout << fixed << "El valor factorial de " << n << " es: " << factorial << endl;
