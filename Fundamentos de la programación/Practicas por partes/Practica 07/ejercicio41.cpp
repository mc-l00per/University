...
int main() {
	...
	cout << "Introduce el mínimo por la izquierda: ";
	cin >> min_izda;
	cout << "Introduce el máximo por la izquierda: ";
	cin >> max_izda;
	cout << "Introduce el mínimo por la derecha: ";
	cin >> min_dcha;
	cout << "Introduce el máximo por la derecha: ";
	cin >> max_dcha;
