...
int main() {
	...
	// CUERPO DEL PROGRAMA 
	total = cantidad + (cantidad * (interes / 100));			//parte A
	cantidad = cantidad + (cantidad * (interes / 100));			//parte B
	
	// SALIDA DE DATOS
	 cout << endl << "Salida de datos del problema A: " << total << endl
	 	<< "Salida de datos del problema B: " << cantidad;
