...
/**
 * Funcion para leer la cadena de datos de string
 * @see LeerDigitos
 * @param &n entero que deseamos combertir en string
 */
void LeerDigitos(int &n){
	cout << "Introduce el valor de n:";
	cin >> n;
}

/**
 * Funcion para pintar digitos como el ejercicio 27
 * @see Digitos
 * @param n entero que queremos pasar a string 
 * @return entero combertido a string
 */
...
* @see MostrarDigitos
* @param digitos string que queremos mostrar por pantalla
*/
void MostrarDigitos(string digitos){
	//cout << digitos;
