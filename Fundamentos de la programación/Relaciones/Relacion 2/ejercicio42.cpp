...
int main() {
	...
	int entero, minimo, maximo, entero_aux, contador = 0;

	// ENTRADA DE DATOS DEL PROGRAMA
	cout << "Introduce el entero, del 1 al 9: ";
	cin >> entero;
	...
	// SALIDA DE DATOS
	cout << "El numero " << entero << " salio " << contador << " veces." << endl;
