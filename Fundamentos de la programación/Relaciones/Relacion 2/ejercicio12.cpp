...
int main() {
	...
	if (letra_original >= 'A' && letra_original <= 'Z'){
		...
		tipo = Tipo::otro_caracter;
	}
	
	// SALIDA DE DATOS
	switch (tipo) {
		case Tipo::mayuscula:
			cout << "la letra era una mayuscula. una vez convertida es ... " << letra_convertida << endl;
			break;
		case Tipo::minuscula:
			cout << "La letra era una minuscula. Una vez convertida es ... " << letra_convertida << endl;
			break;
		case Tipo::otro_caracter:
			cout << "El caracter no era una letra." << endl;
	}
