...
int main() {
	...
	int dato, menor, mayor;
	bool es_mayor = false;

	// ENTRADA DE DATOS DEL PROGRAMA
	cout << "Introduce un entero de la primera cadena: ";
	cin >> dato;
	menor = dato;
	while (dato != 0) {
		cout << "Introduce un entero de la primera cadena: ";
	...
	cout << "Introduce un entero de la segunda cadena: ";
	cin >> dato;
	mayor = dato;
	while (dato != 0) {
		cout << "Introduce un entero de la segunda cadena: ";
	...
	// SALIDA DE DATOS
	if (es_mayor)
		cout << "Todos los de la primera cadena son mayores que la segunda." << endl;
	else
		cout << "No todos los valores de la primera cadena son mayores que los de la segunda" << endl;
