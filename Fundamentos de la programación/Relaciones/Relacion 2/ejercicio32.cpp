...
int main() {
	...
	bool narzicista;
	int entero, tamanio = 1, aux_entero, 
		salida = 0, 
		exponente = 1;
	...
	for (int i = tamanio; i >= 1; i /= 10) {
		salida += pow((aux_entero / i), exponente);
		aux_entero %= i;
	}
	...
	// SALIDA DE DATOS
	if (narzicista)
		cout << "Es un numero narzicista." << endl;
	else
		cout << "No es un numero narzicista." << endl;
