...
int main() {
	...
	for (int i = aux_n_m; i > 1; --i){
		factorial_n *= i;
	}

	resultado = (factorial_n/(factorial_m*factorial_n_m));

	// SALIDA DE DATOS
	cout << fixed << "\nEl resultado combinatorio. " << resultado << endl;
