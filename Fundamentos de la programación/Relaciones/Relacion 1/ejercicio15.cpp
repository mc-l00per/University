...
int main() {
	...
	const int MINUTOS_POR_HORA = 60, SEGUNDOS_POR_MINUTO = 60, DIAS_POR_HORA = 24;
	...
	// CUERPO DEL PROGRAMA 
	minutos = minutos + segundos / SEGUNDOS_POR_MINUTO;
	segundos = segundos % SEGUNDOS_POR_MINUTO;
	horas = horas + minutos / MINUTOS_POR_HORA;
	minutos = minutos % MINUTOS_POR_HORA;
	dias = horas / DIAS_POR_HORA;
	horas = horas % DIAS_POR_HORA;
