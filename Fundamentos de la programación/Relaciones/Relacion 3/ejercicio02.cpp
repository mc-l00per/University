...
/**
 * Funcion para obtener el maximo de un real
 * @see Max
 * @param un_valor Primer real
 * @param otro_valor Segundo real
 * @param el_tercero Tercer real
 * @return max Maximo valor de los tres reales
 */
...
int main() {
	...
	double un_valor, otro_valor, el_tercero, valor_maximo;
	...
	// CUERPO DEL PROGRAMA 
	valor_maximo = Max(un_valor, otro_valor, el_tercero);

	// SALIDA DE DATOS
	cout << "El valor del real maximo es: " << valor_maximo << endl;
